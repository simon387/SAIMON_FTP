	...
	If $iButtonMargin Then
		...
		If $iButtonMargin = 40 Then
			...
			If IsFunc($hUser_Func) Then
				...
				$idUser_Func = GUICtrlCreateButton("Open in Excel", $iButtonWidth_3, $aiGUISize[1] - 20, $iButtonWidth_3, 20);sc0714
				$iButtonWidth_Var = $iButtonWidth_3
				$iOffset = $iButtonWidth_3 * 2
			EndIf
			; Create Exit button and data label
			$idExit_Script = GUICtrlCreateButton("Exit Program", $iOffset, $aiGUISize[1] - 20, $iButtonWidth_Var, 20)
